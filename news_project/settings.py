...
# For production environments, it is strongly recommended to load the
# SECRET_KEY and database credentials from environment variables.
...
# For production, configure a real SMTP backend.
